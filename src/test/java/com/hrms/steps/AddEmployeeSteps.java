...
public void i_click_on_Edit_SaveButton() {
	click(pdetails.edit_saveBtn);
   
}

@Then("I am able to modify Employee Details")
public void i_am_able_to_modify_Employee_Details(DataTable modifyEmpDetail) throws InterruptedException {
	...
	for(Map<String, String> map : modifyList) {
		...
		sendText(pdetails.licenNo, map.get("DriversLisence"));
		...
		selectDbValue(pdetails.maritalStatus, map.get("MaritialStatus"));
		selectDbValue(pdetails.nationality, map.get("Nationality" ));
